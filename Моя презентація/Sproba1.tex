...
\begin{block}{}
\begin{itemize}
\item Розглянути математичні основи еліптичних кривих.\\
\item Дослідити груповий закон для еліптичних кривих $E(F(p))$.\\
\item Розглянути електронний цифровий підпис на еліптичних кривих.\\
\item Програмно реалізувати приклад електронного цифрового підпису на еліптичних кривих.
\end{itemize}
\end{block}
\end{frame}
...
\begin{block}{}
\begin{itemize}
\item Криптографічні методи на еліптичних кривих є надійними і широко застосовуються в системах захисту інформації.\\
\item При використанні при множенні не афінних систем координат досягається зменшення складності в цілому при складанні та подвоєнні точок.\\
\item Розробляються нові і удосконалюються наявні криптографічні методи на еліптичних кривих (наприклад: на основі кривих Едвардса).\\
\item Світовими стандартами цифрового підпису є підпис на еліптичних кривих.
\end{itemize}
\end{block}
\end{frame}
%%%%%%
